...
public final class EmailUtil {
     ...
     * 初始化方法
     */
    public EmailUtil(boolean debug,Map<String,String> propMap) {
    			
        this.mailHost = propMap.get("mail.smtp.host");
        this.port = Integer.valueOf(propMap.get("mail.smtp.port"));
        this.auth = Boolean.valueOf(propMap.get("mail.smtp.auth"));
        this.sender_username = propMap.get("mail.sender.username");
        this.sender_password = propMap.get("mail.sender.password");
