...
<body>
	 <form id="addRoleGroupForm">
		...
		<div style="text-align:center;padding:5px">
	    	<a class="easyui-linkbutton" onclick="saveRoleGroup()">保存</a>
	    	<a class="easyui-linkbutton" onclick="closeAddRoleGroupWindow()">关闭</a>
	    </div>
	</form>	
	<script type="text/javascript">
		...
		function saveRoleGroup(){
			if($("#addRoleGroupForm").form('enableValidation').form('validate')){
				$.ajax({
		               type: "POST",
		...
		function closeAddRoleGroupWindow(){
