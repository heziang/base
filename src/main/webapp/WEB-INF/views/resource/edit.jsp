	 ...
	 <form id="editSysResourceForm">
   		...
   		<table>
    		...
    		<tr>
    			...
    			<td>资源值:</td>
    			<td><input class="easyui-textbox" type="text" name="resourcevalue" data-options="validType:['unnormal','length[0,50]']"></input></td>
    		</tr>
    		<tr>
    			<td>资源类型:</td>
    			<td>
					<input class="easyui-combobox" style="width:100%;" name="resourcetype" required="true" data-options="textField:'text',valueField:'value',url:'<%=getServletContext().getContextPath() %>/dictionary/searchByTypecode/sex.htmls'">
				</td>
    			<td>排序:</td>
