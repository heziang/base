...
},message:"请输入有效的邮箱."},url:{validator:function(_4da){
...
},message:"请输入有效的URL."},length:{validator:function(_4db,_4dc){
var len=$.trim(_4db).length;
return len>=_4dc[0]&&len<=_4dc[1];
},message:"输入字符必须介于 {0} 到 {1}之间."},remote:{validator:function(_4dd,_4de){
var data={};
data[_4de[1]]=_4dd;
